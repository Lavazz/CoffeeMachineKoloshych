...
public class SQLQuery {
    ...
    static final String QUERY_USER_BY_LOGIN = "SELECT * FROM users WHERE login = ?";
    ...
    static final String QUERY_ADDITIONAL_INGREDIENT_BY_ID = "SELECT * FROM additionalIngredients WHERE id_additionalIngredient=?";
    ...
    static final String QUERY_ADDITIONAL_INGREDIENT_ADD = "INSERT INTO additionalIngredients (additionalIngredient, price) values(?, ?)";
    static final String QUERY_ADDITIONAL_INGREDIENT_ADD_FILLING = "INSERT INTO fillingOperations (id_additionalIngredient) value(?)";
    static final String QUERY_ADDITIONAL_INGREDIENT_DELETE = "DELETE FROM additionalIngredients WHERE id_additionalIngredient=?";


    // Basic ingredient
    static final String QUERY_BASIC_INGREDIENT = "SELECT * FROM basicIngredients WHERE id_basicIngredient=?";

    //FillingOperation
    static final String QUERY_FILLING_OPERATION = "SELECT * FROM fillingOperations";
    static final String QUERY_FILLING_OPERATION_ADDITIONAL_INGREDIENT = "SELECT * FROM fillingOperations WHERE id_additionalIngredient=?";
    static final String QUERY_FILLING_OPERATION_BASIC_INGREDIENT = "SELECT * FROM fillingOperations WHERE id_basicIngredient=?";
    static final String QUERY_FILLING_BASIC = "UPDATE BasicIngredients SET portion=? WHERE id_BasicIngredient=?";
    static final String QUERY_FILLING_ADDITIONAL = "UPDATE AdditionalIngredients SET portion=? WHERE id_AdditionalIngredient=?";
    static final String QUERY_FILLING_GET_BASIC = "SELECT * FROM basicIngredients WHERE id_basicIngredient=?";
    static final String QUERY_FILLING_GET_ADDITIONAL_PORTION = "SELECT * FROM additionalIngredients WHERE id_additionalIngredient=?";
