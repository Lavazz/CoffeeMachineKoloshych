...
public class SQLQuery {
    ...
    public static final String QUERY_FILLING_OPERATION_ADDITIONAL_INGREDIENT = "SELECT id_operation, id_drink," +
            ...
            " WHERE id_additional_Ingredient=?";
    public static final String QUERY_GET_MAX_PORTION_DRINK = "SELECT MAXPortion FROM filling_operations" +
            " WHERE id_drink=?";
    public static final String QUERY_GET_MAX_PORTION_ADDITIONAL_INGREDIENT = "SELECT MAXPortion FROM filling_operations" +
            " WHERE id_additional_ingredient=?";
