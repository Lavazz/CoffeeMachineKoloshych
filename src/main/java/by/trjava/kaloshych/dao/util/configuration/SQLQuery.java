...
public class SQLQuery {
    ...
    public static final String QUERY_GET_BALANCE = "SELECT amount_of_money FROM accounts WHERE id_account_user=?";
    public static final String QUERY_ADD_ACCOUNT_USER = "INSERT INTO account_users( id_user) VALUES(?)";


    //AccountUser
    public static final String QUERY_GET_ACCOUNT_USER_BY_USER = "SELECT id_account_user, id_user" +
            " FROM account_users" +
            " WHERE id_user=?";
    public static final String QUERY_GET_ACCOUNT_USER = "SELECT id_account_user, id_user" +
            " FROM account_users" +
    ...
    public static final String QUERY_CHECK_DRINK = "SELECT id_drink FROM drinks WHERE drink=?";
    ...
    public static final String QUERY_ADDITIONAL_INGREDIENT = "SELECT id_additional_Ingredient, additional_Ingredient," +
            " calories, portion, picture_path" +
            " FROM additional_ingredients";

    public static final String QUERY_ADDITIONAL_INGREDIENT_BY_ID = "SELECT id_additional_ingredient, " +
            " additional_ingredient, portion, calories, picture_path" +
            " FROM additional_ingredients" +
            " WHERE id_additional_ingredient=?";

    public static final String QUERY_CHECK_ADDITIONAL_INGREDIENT = "SELECT id_additional_ingredient" +
            " FROM additional_Ingredients" +
            " WHERE additional_ingredient=?";
    ...
    //FillingOperation
    public static final String QUERY_FILLING_OPERATION = "SELECT id_operation, id_drink, " +
            " id_additional_ingredient, MAXPortion" +
            " FROM filling_operations";

    public static final String QUERY_GET_MAX_PORTION_DRINK = "SELECT MAXPortion" +
            " FROM filling_operations" +
            " WHERE id_drink=?";

    public static final String QUERY_GET_MAX_PORTION_ADDITIONAL_INGREDIENT = "SELECT MAXPortion" +
            " FROM filling_operations" +
            " WHERE id_additional_ingredient=?";

    public static final String QUERY_FILLING_DRINK = "UPDATE drinks SET portion=? WHERE id_drink=?";

    public static final String QUERY_FILLING_ADDITIONAL = "UPDATE additional_ingredients" +
            " SET portion=?" +
            " WHERE id_additional_ingredient=?";

    public static final String QUERY_DELETE_DRINK_FROM_FILLING_OPERATION = "DELETE FROM filling_operations" +
            " WHERE id_drink=?";
    ...
    public static final String QUERY_GET_ORDERS_BY_USER = "SELECT o.id_order, o.id_cart_user," +
            " o.date_order, o.total_cost FROM orders o INNER JOIN cart_users cu" +
            " ON o.id_cart_user=cu.id_cart_user" +
            " WHERE cu.id_user=?";

    public static final String QUERY_GET_ORDER = "SELECT id_order, id_cart_user, date_order, total_cost" +
            " FROM orders" +
            " WHERE id_order=?";
    ...
    public static final String QUERY_CART_USER_BY_ID_USER = "SELECT id_cart_user, id_user FROM cart_users" +
            " WHERE id_user=?";

    public static final String QUERY_CART_USER_BY_ID = "SELECT id_cart_user, id_user FROM cart_users" +
            " WHERE id_cart_user=?";
    ...
    public static final String QUERY_GET_ALL_INGREDIENTS = "SELECT id_cart_additional_ingredient, " +
            "id_cart, id_additional_ingredient FROM cart_additional_ingredients" +
            " WHERE id_cart=?";

    public static final String QUERY_CART_DELETE = "DELETE FROM carts WHERE id_cart=?";

    public static final String QUERY_CART_CHANGE_PORTION = "UPDATE carts SET portion=?" +
            " WHERE id_cart=?";
    ...
    public static final String QUERY_ALL_CARTS_BY_USER = "SELECT c.id_cart, c.id_cart_user, c.id_drink, " +
            "c.portion FROM carts c" +
            " INNER JOIN cart_users cu" +
            " ON c.id_cart_user=cu.id_cart_user" +
            " WHERE id_user=?";

    public static final String QUERY_GET_PORTION_BY_CART = "SELECT portion FROM carts" +
            " WHERE id_cart=?";
