package by.trjava.kaloshych.controller.command.impl;//package by.trjava.by.trjava.coffeemachine.controller.command.impl;
//
...
//            int lastIndex = firstIndex + SelectionAllDrinksCommand.rowsByPage;
