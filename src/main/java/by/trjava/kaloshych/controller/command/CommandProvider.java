...
import by.trjava.kaloshych.controller.command.impl.*;
import by.trjava.kaloshych.controller.command.impl.gotopage.*;
...
//        commands.put(CommandName.SHOWPREVIOUSPAGE, new PreviousPageCommand());
      ...
      commands.put(CommandName. GOTOINDEXPAGE, new GoToIndexPageCommand());
        ...
        commands.put(CommandName.FILLINGOPERATION, new FillingOperationCommand());
        commands.put(CommandName. FILLTOMAX, new FillToMaxCommand());
        commands.put(CommandName. GOTOFILLINGOPERATIONPAGE, new GoToFillingOperationPageCommand());
        commands.put(CommandName.GOTOPAGEADMINCABINET, new GoToPageAdminCabinet());
        commands.put(CommandName.EDITINGREDIENT, new EditIngredientCommand());
        commands.put(CommandName.GOTOPAGEEDITINGREDIENT, new GoToPageEditIngredientCommand());
        commands.put(CommandName.DELETEADDITIONALINGREDIENT, new DeleteAdditionalIngredientCommand());
