...
public class Parameter {
    ...
    public static final String PARAMETER_CART = "cart";
    public static final String PARAMETER_CART_USER = "cartUser";
    ...
    public static final String PARAMETER_ACCOUNT_USER = "accountUser";
    public static final String PARAMETER_USER_STATUS = "userStatus";
    ...
    public static final String PARAMETER_CURRENT_PAGE = "currentPageURL";
