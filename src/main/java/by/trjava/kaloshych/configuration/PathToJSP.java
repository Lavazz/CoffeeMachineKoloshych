...
public class PathToJSP {
 ...
 public static final String PATH_SHOW_ADMIN_CABINET="adminCabinet";
    public static final String PATH_CART="showCart";
    public static final String PATH_COMMAND_PERSONAL_CABINET = "/main?command=personalCabinet";
    public static final String PATH_DRINKS="showDrinks";
 ...
 // public static final String PATH_CHANGE_PASSWORD="/main?command=showCart";
    ...
    public static final String PATH_COMMAND_REPLENISH_BALANCE_WITH_MESSAGE="/main?command=showReplenishBalanceForm&messageOrder=message.order.insufficient_money";
    public static final String PATH_CHANGE_PASSWORD="changePassword";
    public static final String PATH_COMMAND_REPLENISH_BALANCE_FORM="/main?command=showReplenishBalanceForm";
    public static final String PATH_COMMAND_DELETE_COMPONENT="/main?command=goToDeleteComponentPage";
    public static final String PATH_COMMAND_FILLING_OPERATION="/main?command=goToFillingOperationPage";
}
