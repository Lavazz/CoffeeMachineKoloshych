...
VALUES (1, 10, 4, '2019-11-26', 2),
       (2, 10, 3, '2019-11-26', 12),
       (3, 10, 1, '2019-11-26', 6),
       (4, 10, 5, '2019-11-26', 506),
       (5, 11, 1, '2019-11-26', 5),
       (6, 10, 6, '2019-11-26', 511),
       (7, 12, 1, '2019-11-27', 5),
       (8, 12, 4, '2019-11-27', 15);
UNLOCK TABLES;
...
(
    ...
    `picture_path`             varchar(80)          DEFAULT 'pictures/4212.jpg',
...
VALUES (101, 'Сахар', 1958, 387, 'pictures/additionalIngredient/additionalIngredient101.jpg'),
       (102, 'Сливки', 375, 196, 'pictures/additionalIngredient/additionalIngredient102.jpg'),
       (103, 'Шоколадная крошка', 391, 546, 'pictures/additionalIngredient/additionalIngredient103.jpg');
UNLOCK TABLES;
...
INSERT INTO `cart_additional_ingredients`
VALUES (1, 3, 102),
       (2, 4, 101),
       (3, 4, 102),
       (4, 4, 103),
       ...
       (192, 229, 103),
       (193, 232, 103);
/*!40000 ALTER TABLE `cart_additional_ingredients`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `cart_users`
    DISABLE KEYS */;
INSERT INTO `cart_users`
VALUES (1, 1);
/*!40000 ALTER TABLE `cart_users`
    ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `drinks`
VALUES (1, 'Латте макиато', 600, 3.00,
        'Горячий кофейный напиток, приготавливаемый путём вливания в молоко кофе-эспрессо в пропорции 3:1. Колорийность 29ккал',
        'pictures/drinks/1.jpg'),
       (2, 'Американо', 360, 2.00,
        'Чёрный кофе, приготовленный в специальной кофеварке, где сквозь спрессованные молотые зёрна пропускают горячую воду под давлением. Калорийность 10ккал',
        'pictures/drinks/2.jpg'),
       (3, 'Эспрессо', 500, 1.50,
        'Чёрный кофе, приготовленный в специальной кофеварке, где сквозь спрессованные молотые зёрна пропускают горячую воду под давлением. Концентрированее, чем американо. Калорийность 10ккал. ',
        'pictures/drinks/3.jpg'),
       (4, 'Капучино', 294, 2.50,
        'Итальянский кофейный напиток содержит кофе с молоком в равных количествах и густой молочной пеной. Каллорийность 40ккал',
        'pictures/drinks/4.jpg'),
       (5, 'Ирландский кофе', 550, 3.00,
        'Кофейный напиток, на основе ароматизатора \"Ирландского виски\", чёрного кофе, взбитых сливок и коричневого сахара. Колорийность 150ккал.',
        'pictures/drinks/5.jpg'),
       (6, 'Венский кофе', 345, 2.80, 'Кофе со взбитыми сливками.  Калорийность 175 ккал', 'pictures/drinks/6.jpg'),
       (7, 'Горячий шоколад', 404, 3.00,
        'Напиток, в состав которого обязательно входит какао, а также молоко и сахар. калорийность 77ккал',
        'pictures/drinks/7.jpg'),
       (8, 'Чай фруктовый', 1, 1.50, 'Чай из сочного букета ягод и фруктов. Калорийность 2 ккал.',
        'pictures/drinks/8.jpg');
UNLOCK TABLES;
...
INSERT INTO `users`
VALUES (1, 'koloshych@gmail.com', 'Kate', '����BW�;8����)1�', 'Kate', 1),
       (2, 'nebo10@mail.ru', 'Matroskin', 'v2�Ő�J��0M��p��', 'Artem', 2),
       (3, 'chipollino@gmail.com', 'chipalino', 'HEq����*�@�w�x�', 'Egor', 2),
       (4, 'malvina@yandex.ru', 'Malvina', '����b����/��~�', 'Marina', 2);
UNLOCK TABLES;
