...
<html lang="ru">
<head>
    <title><fmt:message key="title.deleteComponent"/></title>
    <meta charset="utf-8">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a href="main?command=goToDeleteComponentPage" class="nav-link">
                <fmt:message key="main.message.delete_ingredient" /></a>
            </li>
                <c:import url="/WEB-INF/jsp/nawCabinet.jsp"/>
                <c:import url="/WEB-INF/jsp/nawCartAndLogout.jsp"/>  </ul>
